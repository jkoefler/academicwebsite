      ...
      <div className="flex flex-col gap-5">
        <p className="text-balance tracking-wider lg:tracking-normal text-zinc-600 text-lg select-none">
          ...
          <Link className="underline font-bold" href="https://positive-geometry.com/">UNIVERSE+</Link> {" "}
           project, where we explore more connections between fundamental Physics and Positive Geometry. I am a contributor to the Math-AI benchmark{" "} <Link className="underline font-bold" href="https://math.science-bench.ai">science-bench</Link>. 
